                    ...
                    {categories.map((category, idx) => (
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                <h3 className="text-[12px] uppercase tracking-[0.3em] font-black text-brand-ink group-hover:text-brand-bronze transition-colors flex justify-between items-center pr-4">
                                    {category.name}
