              ...
              return (
                <div key={testimonial._id} className="p-4 hover:bg-gray-50 transition-colors duration-150">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`px-2 py-1 text-xs leading-4 font-semibold rounded-full ${testimonial.status === 'approved'
              ...
              {testimonials.map(testimonial => {
                ...
                return (
                  <tr key={testimonial._id} className="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td className="px-4 lg:px-6 py-4 whitespace-nowrap text-sm">
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${testimonial.status === 'approved'
                          ? 'bg-green-100 text-green-800'
                          : 'bg-orange-100 text-orange-800'
                        }`}>
                        {testimonial.status}
              ...
              <div className="flex justify-center mt-6 sm:mt-8 space-x-2 sm:space-x-3">
                {approvedTestimonials.map((_, index) => (
                  <button
                    ...
                    className={`size-2 sm:size-3 rounded-full transition-all duration-300 ${index === currentSlide
