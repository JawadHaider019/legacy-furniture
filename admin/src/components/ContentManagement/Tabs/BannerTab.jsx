      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 md:p-5 border-b border-gray-200 gap-3 sm:gap-0">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button
            ...
            disabled={saving}
            className={`flex-1 sm:flex-none flex items-center gap-1 text-xs sm:text-sm px-2 sm:px-3 py-2 transition-colors rounded-md ${banner.isEditing
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-30">
          {activeBanners.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 transition-all duration-300 rounded-full ${index === currentBannerIndex
                ? 'bg-white scale-110'
