            ...
            <div className="p-6">
              <div className="flex items-center mb-4">
                <FontAwesomeIcon
                  ...
                  className={`text-2xl mr-3 ${modalConfig.type === 'error' ? 'text-red-500' : 'text-yellow-500'
                    }`}
                />
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  ...
                  className={`px-4 py-2 text-white rounded transition-colors ${modalConfig.type === 'error'
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {teams.map((team, index) => (
              <div
                key={team._id}
                className={`bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group relative ${dragOverItem === index ? 'ring-2 ring-blue-500 ring-opacity-50' : ''
